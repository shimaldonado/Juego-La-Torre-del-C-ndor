...
export const CHARACTERS = {
  auki: {
    ...
    power: {
      id: 'remolino',
      name: 'Remolino Dorado',
      icon: '⚡💎',
      summary: 'Lanza un proyectil dorado hacia adelante.',
      uiDetail: 'Proyectil dorado frontal',
      range: 145,
      radius: 78,
      damage: 1,
      points: 130,
  ...
  killa: {
    ...
    power: {
      ...
      name: 'Zorro Lunar',
      icon: '🦊🌙',
      summary: 'La mascota ataca enemigos cercanos en área.',
      uiDetail: 'Ataque en área · radio 220px',
      radius: 220,
      damage: 1,
      points: 150,
    },
  ...
  rumi: {
    ...
    power: {
      ...
      name: 'Puño de Piedra',
      icon: '🪨🛡️',
      summary: 'Golpe de tierra frontal y escudo breve.',
      uiDetail: 'Golpe de tierra + 2s de escudo',
      range: 125,
      radius: 92,
      damage: 2,
      points: 170,
