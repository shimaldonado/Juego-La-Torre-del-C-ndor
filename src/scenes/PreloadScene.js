...
export class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // Killa: idle + 5 animaciones
    this.load.image('killa_idle', `${base}/personajes/killa_idle.png`);
    this.load.spritesheet('killa_correr', `${base}/personajes/killa_correr_sheet.png`, { frameWidth: 150, frameHeight: 160 });
    this.load.spritesheet('killa_salto',  `${base}/personajes/killa_salto_sheet.png`,  { frameWidth: 150, frameHeight: 160 });
    this.load.spritesheet('killa_caida',  `${base}/personajes/killa_caida_sheet.png`,  { frameWidth: 150, frameHeight: 160 });
    this.load.spritesheet('killa_golpe',  `${base}/personajes/killa_golpe_sheet.png`,  { frameWidth: 150, frameHeight: 160 });
    this.load.spritesheet('killa_muerte', `${base}/personajes/killa_muerte_sheet.png`, { frameWidth: 150, frameHeight: 160 });

    // Poderes especiales
    this.load.spritesheet('killa_poder', `${base}/personajes/killa_poder_sheet.png`, { frameWidth: 150, frameHeight: 160 });
    this.load.spritesheet('rumi_poder',  `${base}/personajes/rumi_poder_sheet.png`,  { frameWidth: 150, frameHeight: 160 });

    // Rumi: idle + 5 animaciones
    this.load.image('rumi_idle', `${base}/personajes/rumi_idle.png`);
    this.load.spritesheet('rumi_correr', `${base}/personajes/rumi_correr_sheet.png`, { frameWidth: 150, frameHeight: 160 });
    this.load.spritesheet('rumi_salto',  `${base}/personajes/rumi_salto_sheet.png`,  { frameWidth: 150, frameHeight: 160 });
    this.load.spritesheet('rumi_caida',  `${base}/personajes/rumi_caida_sheet.png`,  { frameWidth: 150, frameHeight: 160 });
    this.load.spritesheet('rumi_golpe',  `${base}/personajes/rumi_golpe_sheet.png`,  { frameWidth: 150, frameHeight: 160 });
    this.load.spritesheet('rumi_muerte', `${base}/personajes/rumi_muerte_sheet.png`, { frameWidth: 150, frameHeight: 160 });
  ...
  createAnimations() {
    ...
    // Killa animations
    make('killa_run',   'killa_correr', 0, 4, 12);    // 5 frames
    make('killa_jump',  'killa_salto',  0, 3,  8);    // 4 frames
    make('killa_fall',  'killa_caida',  0, 2,  7);    // 3 frames
    make('killa_hit',   'killa_golpe',  0, 3, 10, 0); // 4 frames
    make('killa_death', 'killa_muerte', 0, 3,  7, 0); // 4 frames

    make('killa_power', 'killa_poder', 0, 2,  9, 0); // 3 frames - mascota
    // Rumi animations
    make('rumi_run',   'rumi_correr', 0, 3, 12);    // 4 frames
    make('rumi_jump',  'rumi_salto',  0, 3,  8);    // 4 frames
    make('rumi_fall',  'rumi_caida',  0, 2,  7);    // 3 frames
    make('rumi_hit',   'rumi_golpe',  0, 3, 10, 0); // 4 frames
    make('rumi_death', 'rumi_muerte', 0, 3,  7, 0); // 4 frames

    make('rumi_power',  'rumi_poder',  0, 3,  9, 0); // 4 frames - poder
